...
function initializeParticipants() {
  participants.value = Array.from({ length: totalParticipants.value }, (_, i) => ({
...
const step1Valid = computed(() => {
  return contactForm.value.email &&
...
const step2Valid = computed(() => {
  return participants.value.every(p =>
    p.fullName && p.email && p.documentNumber
  )
})
...
function nextStep() {
  ...
  if (currentStep.value === 2 && !step2Valid.value) {
    toast.add({
      color: 'warning',
      title: 'Información incompleta',
      description: 'Por favor completa la información de todos los participantes'
    })
    return
  }
        ...
        <div class="lg:col-span-2">
          ...
          <div class="mb-8">
            ...
            <div class="flex justify-between text-sm">
              <span :class="currentStep >= 1 ? 'text-neutral-900 dark:text-white font-medium' : 'text-neutral-500 dark:text-neutral-400'">
                Contacto
              </span>
              <span :class="currentStep >= 2 ? 'text-neutral-900 dark:text-white font-medium' : 'text-neutral-500 dark:text-neutral-400'">
                Participantes
              </span>
              <span :class="currentStep >= 3 ? 'text-neutral-900 dark:text-white font-medium' : 'text-neutral-500 dark:text-neutral-400'">
                Pago
              </span>
            </div>
          </div>
          ...
          <UCard v-if="currentStep === 2">
            <template #header>
              ...
              <p class="text-sm text-neutral-500 dark:text-neutral-400 mt-1">
                {{ totalParticipants }} {{ totalParticipants === 1 ? 'persona' : 'personas' }} en total
              </p>
            </template>
            ...
            <div class="space-y-6">
              ...
              >
                <h3 class="font-medium text-neutral-900 dark:text-white mb-4">
                  ...
                  <span v-if="index === 0" class="text-sm text-neutral-500 dark:text-neutral-400 font-normal ml-2">
                    (Contacto principal)
                  </span>
                </h3>
            ...
            <div class="space-y-4">
              ...
              >
                <div class="flex items-center gap-3">
                  <UIcon name="i-lucide-credit-card" class="w-6 h-6 text-primary" />
                  <div>
                    <p class="font-medium text-neutral-900 dark:text-white">Tarjeta de Crédito/Débito</p>
              ...
              >
                <div class="flex items-center gap-3">
                  ...
                  <div>
                    <p class="font-medium text-neutral-900 dark:text-white">Transferencia Bancaria</p>
                    <p class="text-sm text-neutral-500 dark:text-neutral-400">Pago directo desde tu banco</p>
                  </div>
                </div>
              </div>
              ...
              <div class="mt-6 p-4 bg-neutral-100 dark:bg-neutral-800 rounded-lg">
                <p class="text-sm text-neutral-600 dark:text-neutral-400">
                  ...
                  Este es un pago de demostración. No se procesará ningún cargo real.
                </p>
              </div>
            </div>
        ...
        <div class="lg:col-span-1">
          <div class="sticky top-4">
            <UCard>
              ...
              <div class="space-y-4">
                <!-- Cart Items -->
                <div v-for="item in cartStore.cart.items" :key="item.itemId" class="pb-4 border-b border-neutral-200 dark:border-neutral-700">
