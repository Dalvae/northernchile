...
useSeoMeta({
  ...
  description: 'Contáctanos para consultas sobre tours astronómicos, reservas especiales y más información sobre nuestros servicios.',
...
const faqs = [
  {
    ...
    answer: 'No, nuestros tours están diseñados para todos los niveles. Nuestros guías explicarán todo lo necesario.'
  },
  {
    question: '¿Qué pasa si hay mal clima?',
    answer: 'Monitoreamos constantemente las condiciones climáticas. Si se cancela por mal clima, ofrecemos reprogramación o reembolso completo.'
  },
  {
    question: '¿Los tours incluyen transporte?',
    answer: 'Sí, todos nuestros tours incluyen transporte desde tu alojamiento en San Pedro de Atacama.'
  },
  {
    question: '¿Puedo hacer una reserva privada?',
    answer: 'Sí, ofrecemos tours privados. Contáctanos para coordinar una experiencia personalizada.'
  }
]
      ...
      <UContainer>
        <div class="max-w-3xl mx-auto text-center">
          ...
          <p class="text-xl text-neutral-300">
            Estamos aquí para responder tus preguntas y ayudarte a planificar tu aventura astronómica
          </p>
        </div>
      </UContainer>
    </section>
    ...
    <section class="py-16 bg-white dark:bg-neutral-900">
      <UContainer>
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
          <div v-for="info in contactInfo" :key="info.title" class="text-center">
            <div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary-100 dark:bg-primary-900/30 mb-4">
              <UIcon :name="info.icon" class="w-8 h-8 text-primary-600 dark:text-primary-400" />
            </div>
            <h3 class="text-lg font-semibold text-neutral-900 dark:text-white mb-3">
              {{ info.title }}
            </h3>
            <div class="space-y-1">
              <p v-for="detail in info.details" :key="detail" class="text-neutral-600 dark:text-neutral-400 text-sm">
                {{ detail }}
              </p>
            </div>
          </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div>
            ...
            <!-- Map placeholder -->
            <div class="w-full h-64 bg-neutral-200 dark:bg-neutral-800 rounded-xl mb-6 flex items-center justify-center overflow-hidden">
              <div class="text-center p-8">
                <UIcon name="i-lucide-map" class="w-12 h-12 text-neutral-400 mx-auto mb-3" />
