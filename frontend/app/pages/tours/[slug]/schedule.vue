...
function selectSchedule(schedule: any) {
  ...
  console.log('Modal should open now, showParticipantModal:', showParticipantModal.value)
}
              ...
              <div class="space-y-3">
                ...
                >
                  <div class="flex items-center justify-between mb-2">
                    ...
                    <UBadge
                      :color="schedule.status === 'OPEN' ? 'success' : 'warning'"
                      size="sm"
                    >
                      {{ schedule.status }}
                    </UBadge>
            ...
            <div class="space-y-6">
              <div>
                ...
                <div class="flex items-center gap-4">
                  ...
                  />
                  <span class="text-2xl font-bold text-neutral-900 dark:text-white w-12 text-center">
                    {{ participantCount }}
                  </span>
                  <UButton
                    icon="i-lucide-plus"
                    color="neutral"
                    :disabled="participantCount >= (selectedSchedule?.maxParticipants || 15)"
                    @click="participantCount++"
                  />
                </div>
              </div>
