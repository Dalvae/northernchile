...
<template>
  <UModal>
    ...
    <!-- CONTENIDO DEL MODAL - QUITAMOS OVERFLOW HIDDEN -->
    <template #content>
      <UCard class="w-full max-w-4xl mx-auto max-h-[90vh] flex flex-col">
        <template #header>
        ...
        <!-- Contenido scrolleable - QUITAMOS OVERFLOW HIDDEN DEL PARENT -->
